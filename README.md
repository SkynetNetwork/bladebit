# BladeBit Skynet Plotter

[![Release Builds](https://github.com/SkynetNetwork/bladebit/actions/workflows/build-release.yml/badge.svg?branch=master&event=push)](https://github.com/SkynetNetwork/bladebit/actions/workflows/build-release.yml)

A fast **RAM-only**, **k32-only**, Skynet plotter.
...
git clone https://github.com/SkynetNetwork/bladebit.git && cd bladebit
...
## Pool Plots
Pool plots are fully supported and tested against the skynet-blockchain implementation. The community has also verified that pool plots are working properly and winning proofs with them.
...
Copyright 2021 Harold Brenes, Skynet Network Inc
