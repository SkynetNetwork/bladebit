...
///
/// These are extracted from skynetpos.
/// Comments are taken directly from skynetpos unless otherwise specified.
///
...
// @Harold: Not that we changed this from 1-indexing in the skynetpos implementation
